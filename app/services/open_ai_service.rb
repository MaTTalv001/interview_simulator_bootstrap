  ...
  def self.generate_questions(readme_contents)
    ...
    response = client.chat(
      parameters: {
        model: "gpt-4o",
        messages: [
          {role: "system", content: "あなたはエンジニアの採用担当者で入社志望者との面談をします。志望者はポートフォリオのREADMEをあなたに提供します。その内容を確認し、エンジニア目線で、厳しい質問を3つ考えてください。なお、あなたの回答を配列化して扱うため、下記のフォーマットで回答してください。それ以外は不要です。フォーマット：　['質問1','質問2','質問3']"},
